...
const Footer = () => {
    ...
    return (
        ...
        <div className='max-w-screen-xl mx-auto px-4'>
          <div className='mt-3 flex max-w-xs mx-auto items-center justify-between'>
            <a
          ...
          <div className='text-center text-cyan-600 pt-4 sm:pt-12 font-light flex items-center justify-center'>
            <h6 className="font-semibold text-white">Copyright &copy {year}</h6>
          </div>
        </div>
      </footer>
        // <footer className="text-center mt-4 bg-emerald-500 text-white p-3 ">
        //     <p><small className="font-semibold">Copyright &copy {year}</small></p>
        // </footer>
    );
};
